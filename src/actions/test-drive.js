...
export async function bookTestDrive({
  ...
  try {
    ...
    const userExistingBooking = await db.TestDriveBooking.findFirst({
      where: {
        carId,
        userId: user.id,
    ...
    if (userExistingBooking)
      throw new Error(
        "You already have an active test drive booking for this car. Please cancel it first if you want to reschedule."
      );

    // check if a booking already exits for this time slot
