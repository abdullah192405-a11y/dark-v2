...
const CarFiltersControl = ({
  ...
  ].filter(section => section.options && section.options.length > 0); // Only show filters with options
      ...
      <div className="space-y-4 border-b">
        ...
        <div className="px-2 space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="font-medium text-sm">{formatSaudiRiyalReact(priceRange[1])}</div>
            <div className="font-medium text-sm">{formatSaudiRiyalReact(priceRange[0])}</div>
          </div>
        </div>
      </div>
